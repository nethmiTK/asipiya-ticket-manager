          ...
          <table className="min-w-full">
            <thead className="bg-gray-200">
              <tr>
                ...
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">System Name</th>
                <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Company Name</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {currentItems.map((ticket) => (
                <tr key={ticket.TicketID} className="hover:bg-gray-50 cursor-pointer">
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#{ticket.TicketID}</td>
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{ticket.SystemName || "N/A"}</td>
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{ticket.CompanyName || "N/A"}</td>
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{ticket.UserName || "N/A"}</td>
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">{ticket.DateTime ? new Date(ticket.DateTime).toLocaleString() : "N/A"}</td>
