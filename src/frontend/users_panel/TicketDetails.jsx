    ...
    <div className="flex">
      ...
      <div
        className={`flex-1 flex flex-col h-screen overflow-y-auto transition-all duration-300
          ml-0 
          lg:ml-20 ${isSidebarOpen ? 'lg:ml-72' : ''} /* Desktop margin changes based on sidebar state */
        `}
      >
        <NavBar
                      ...
                      {evidenceFiles.map((file, index) => {
                        ...
                        if (/\.(jpg|jpeg|png|gif)$/i.test(lowerPath)) {
                          return (
                            <div
                              key={index}
                              className="rounded p-1 bg-white shadow-sm"
                            >
                              <img
                                src={fileUrl}
                              ...
                              <a
                                ...
                                className="text-blue-600 underline block mt-1 text-center text-sm"
                              >
                                View File
                              </a>
                            </div>
                          ...
                          return (
                            <div
                              key={index}
                              className="rounded p-2 bg-white shadow-sm flex flex-col items-center justify-center text-center"
                            >
                              <a
                                href={fileUrl}
                                target="_blank"
                          ...
                          return (
                            <div
                              key={index}
                              className="rounded p-2 bg-white shadow-sm flex items-center justify-center"
                            >
                              <a
                                href={fileUrl}
                                target="_blank"
