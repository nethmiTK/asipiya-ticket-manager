              ...
              >
                <Form className="space-y-4">
                  ...
                  <div>
                    ...
                    <div
                      {...getRootProps()}
                      className="border-dashed border-2 h-70 border-gray-300 rounded-md p-6 text-center hover:border-gray-400 cursor-pointer mt-1"
                    >
                      <input {...getInputProps()} />
                      {files.length === 0 ? (
                        <>
                          <p className="text-gray-500 text-sm mt-25">
